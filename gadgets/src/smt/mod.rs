...
use crate::{
    ...
    utils::{
        ...
        scalar::{get_bits, ScalarBits, ScalarBytes},
    },
};
...
pub struct VanillaSparseMerkleTree {
    ...
    pub root: Scalar,
    curr_index: Scalar,
    pub(crate) leaf_indices: HashMap<ScalarBytes, Scalar>,
}
...
impl VanillaSparseMerkleTree {
    ...
    pub fn prove_zk<T: BorrowMut<Transcript>>(
        &self,
        root: Scalar,
        leaf: Scalar,
        ...
        let (com_leaf, var_leaf) =
            prover.commit(leaf, Scalar::random(&mut test_rng));
...
pub fn vanilla_merkle_tree_verif_gadget<CS: ConstraintSystem>(
    cs: &mut CS,
    depth: usize,
    root: &Scalar,
