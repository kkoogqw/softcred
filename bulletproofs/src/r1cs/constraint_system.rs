...
pub trait ConstraintSystem {
    ...
    /// this method. The output of a multiplier is assigned on a even call,
    /// when `right` is assigned.
    ///
    /// When CS is committed at the end of the first or second phase, the
    /// half-assigned multiplier has the `right` assigned to zero and all
    /// its variables committed.
    ///
    ...
    // New items from https://github.com/tangle-network/bulletproofs.git
